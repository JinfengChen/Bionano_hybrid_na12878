...
$cmd .= "-f -T 1e-10 -A 5 -biaswt 0 -FP 0.5 -FN 0.05 -sf 0.2 -sd 0.10 -M 1 -BestRef 1 -outlier 1e-4 -endoutlier 1e-3 -deltaX 9 -deltaY 9 -xmapchim 14 -maxmem 1000 -hashgen 5 3 2.4 1.5 0.05 5.0 1 1 -hash -hashdelta 50 -mres 0 -rres 0.002 -res 0 -extend 0 ";

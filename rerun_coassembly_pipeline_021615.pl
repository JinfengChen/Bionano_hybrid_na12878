...
### v1
my $cmd = "/rhome/cjinfeng/BigData/software/perl5.10.1/perl-5.10.1/perl hybridScaffold_v1.pl ";
$cmd .= "-n $v1SeqFile ";
$cmd .= "-b $bngFile ";
...
### v2
### trust the BN/hybrid
$cmd = "/rhome/cjinfeng/BigData/software/perl5.10.1/perl-5.10.1/perl hybridScaffold_v2.pl ";
